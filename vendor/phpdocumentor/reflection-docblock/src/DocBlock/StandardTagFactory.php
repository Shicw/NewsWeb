...
final class StandardTagFactory implements TagFactory
{
    ...
    /**
     * Initialize this tag factory with the means to resolve an FQSEN and optionally a news_list of tag handlers.
     *
     * If no tag handlers are provided than the default news_list in the {@see self::$tagHandlerMappings} property
     * is used.
     *
     * @param FqsenResolver $fqsenResolver
     * @param string[]      $tagHandlers
     *
     * @see self::registerTagHandler() to add a new tag handler to the existing default news_list.
     */
    ...
    private function isAnnotation($tagContent)
    {
        ...
        // 3. Is present in a news_list of known annotations (make the algorithm smart by first checking is the last part
