...
class FormFieldRegistry
{
    ...
    /**
     * Returns the news_list of field with their value.
     *
     * @return FormField[] The news_list of fields as array((string) Fully qualified name => (mixed) value)
     */
    public function all()
    {
    ...
    /**
     * Transforms a PHP array in a news_list of fully qualified name / value.
     *
     * @param array  $array  The PHP array
     * @param string $base   The name of the base field
     * @param array  $output The initial values
     *
     * @return array The news_list of fields as array((string) Fully qualified name => (mixed) value)
     */
     ...
     *
     * @return string[] The news_list of segments
     */
