...
EOF
    ...
    public function testEq()
    {
        ...
        $this->assertEquals('Two', $crawler->eq(1)->text(), '->eq() returns the nth node of the news_list');
    ...
    public function testEach()
    {
        ...
        $this->assertEquals(array('0-One', '1-Two', '2-Three'), $data, '->each() executes an anonymous function on each node of the news_list');
    }
    ...
    public function testSlice()
    {
        ...
        $this->assertCount(3, $crawler->slice(), '->slice() does not slice the nodes in the news_list if any param is entered');
        $this->assertCount(1, $crawler->slice(1, 1), '->slice() slices the nodes in the news_list');
    }
    ...
    public function testReduce()
    {
        ...
        $this->assertCount(2, $nodes, '->reduce() filters the nodes in the news_list');
    }

    public function testAttr()
    {
        $this->assertEquals('first', $this->createTestCrawler()->filterXPath('//li')->attr('class'), '->attr() returns the attribute of the first element of the node news_list');

        try {
            $this->createTestCrawler()->filterXPath('//ol')->attr('class');
            $this->fail('->attr() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->attr() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    {
        $this->assertEquals('li', $this->createTestCrawler()->filterXPath('//li')->nodeName(), '->nodeName() returns the node name of the first element of the node news_list');

        try {
            $this->createTestCrawler()->filterXPath('//ol')->nodeName();
            $this->fail('->nodeName() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->nodeName() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }

    public function testText()
    {
        $this->assertEquals('One', $this->createTestCrawler()->filterXPath('//li')->text(), '->text() returns the node value of the first element of the node news_list');

        try {
            $this->createTestCrawler()->filterXPath('//ol')->text();
            $this->fail('->text() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->text() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testHtml()
    {
        ...
        try {
            ...
            $this->fail('->html() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->html() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testExtract()
    {
        ...
        $this->assertEquals(array('One', 'Two', 'Three'), $crawler->extract('_text'), '->extract() returns an array of extracted data from the node news_list');
        $this->assertEquals(array(array('One', 'first'), array('Two', ''), array('Three', '')), $crawler->extract(array('_text', 'class')), '->extract() returns an array of extracted data from the node news_list');

        $this->assertEquals(array(), $this->createTestCrawler()->filterXPath('//ol')->extract('_text'), '->extract() returns an empty array if the node news_list is empty');
    }
    ...
    public function testFilterXPath()
    {
        ...
        $this->assertCount(6, $crawler->filterXPath('//li'), '->filterXPath() filters the node news_list with the XPath expression');
    ...
    public function testFilter()
    {
        ...
        $this->assertCount(6, $crawler->filter('li'), '->filter() filters the node news_list with the CSS selector');
    }
...
<body>
    <div id="action">
        <a href="/index.phpgin">login</a>
    </div>
    <form id="login-form" action="/Indexe/login" method="post">
...
<body>
    <div id="action">
        <a href="/Indexe/login">login</a>
    </div>
    <form id="login-form" action="/index.phpgin" method="post">
        <button type="submit" name='Click "Here"'>Submit</button>
    </form>
</body>
</html>
HTML;
    ...
    public function testLink()
    {
        ...
        try {
            ...
            $this->fail('->link() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->link() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
...
HTML;
    ...
    public function testForm()
    {
        ...
        try {
            ...
            $this->fail('->form() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->form() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testSiblings()
    {
        ...
        try {
            ...
            $this->fail('->siblings() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->siblings() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testNextAll()
    {
        ...
        try {
            ...
            $this->fail('->nextAll() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->nextAll() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testPreviousAll()
    {
        ...
        try {
            ...
            $this->fail('->previousAll() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->previousAll() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
    ...
    public function testChildren()
    {
        ...
        try {
            ...
            $this->fail('->children() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->children() throws an \InvalidArgumentException if the node news_list is empty');
        }
    ...
    public function testParents()
    {
        ...
        try {
            ...
            $this->fail('->parents() throws an \InvalidArgumentException if the node news_list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(true, '->parents() throws an \InvalidArgumentException if the node news_list is empty');
        }
    }
