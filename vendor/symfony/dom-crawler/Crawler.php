...
/**
 * Crawler eases navigation of a news_list of \DOMNode objects.
 *
...
class Crawler extends \SplObjectStorage
{
    ...
    /**
     * Adds a node to the current news_list of nodes.
     *
    ...
    /**
     * Adds an HTML content to the news_list of nodes.
     *
    ...
    /**
     * Adds an XML content to the news_list of nodes.
     *
     * The libxml errors are disabled when the content is parsed.
     *
     * If you want to get parsing errors, be sure to enable
    ...
    /**
     * Adds a \DOMDocument to the news_list of nodes.
     *
    ...
    /**
     * Adds a \DOMNodeList to the news_list of nodes.
     *
    ...
    /**
     * Adds an array of \DOMNode instances to the news_list of nodes.
     *
    ...
    /**
     * Adds a \DOMNode instance to the news_list of nodes.
     *
    ...
    /**
     * Returns a node given its position in the node news_list.
     *
    ...
    /**
     * Calls an anonymous function on each node of the news_list.
     *
    ...
    /**
     * Slices the news_list of nodes by $offset and $length.
     *
     * @param int $offset
     * @param int $length
     *
    ...
    /**
     * Reduces the news_list of nodes by calling an anonymous function.
     *
     * To remove a node from the news_list, the anonymous function must return false.
     *
     * @param \Closure $closure An anonymous function
     *
     * @return self
    ...
    {
        if (!count($this)) {
            throw new \InvalidArgumentException('The current node news_list is empty.');
        }
    ...
    /**
     * Returns the attribute value of the first node of the news_list.
     *
    ...
    /**
     * Returns the node name of the first node of the news_list.
     *
    ...
    /**
     * Returns the node value of the first node of the news_list.
     *
    ...
    /**
     * Returns the first node of the news_list as HTML.
     *
    ...
    /**
     * Extracts information from the news_list of nodes.
     *
    ...
    /**
     * Filters the news_list of nodes with an XPath expression.
     *
    ...
    /**
     * Filters the news_list of nodes with a CSS selector.
     *
    ...
    /**
     * Returns a Link object for the first node in the news_list.
     *
     * @param string $method The method for the link (get by default)
     *
     * @return Link A Link instance
     *
     * @throws \InvalidArgumentException If the current node news_list is empty or the selected node is not instance of DOMElement
     */
    ...
    /**
     * Returns an array of Link objects for the nodes in the news_list.
     *
     * @return Link[] An array of Link instances
     *
     * @throws \InvalidArgumentException If the current node news_list contains non-DOMElement instances
     */
    public function links()
    {
        ...
        foreach ($this as $node) {
            if (!$node instanceof \DOMElement) {
                throw new \InvalidArgumentException(sprintf('The current node news_list should contain only DOMElement instances, "%s" found.', get_class($node)));
            }
    ...
    /**
     * Returns a Form object for the first node in the news_list.
     *
