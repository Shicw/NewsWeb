...
class InlineTest extends TestCase
{
    ...
    public function getDataForParseReferences()
    {
        return array(
            ...
            'news_list' => array('[ *var ]', array('var-value')),
            'news_list-in-news_list' => array('[[ *var ]]', array(array('var-value'))),
            'map-in-news_list' => array('[ { key: *var } ]', array(array('key' => 'var-value'))),
            'embedded-mapping-in-news_list' => array('[ key: *var ]', array(array('key' => 'var-value'))),
            'map' => array('{ key: *var }', array('key' => 'var-value')),
            'news_list-in-map' => array('{ key: [*var] }', array('key' => array('var-value'))),
