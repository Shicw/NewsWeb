 ...
 *
 * Checks the parameters of the incoming invocations, the parameter news_list is
 * checked against the defined constraints in $parameters. If the constraint
 * is met it will return true in matches().
 *
 * It takes a news_list of match groups and and increases a call index after each invocation.
